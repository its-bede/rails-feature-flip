...
install 
```bash
bin/rails g rails_feature_flip:install
```
...
Everyone interacting in the Rails::Feature::Flip project's codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/rails-feature-flip/blob/main/CODE_OF_CONDUCT.md).
